...
rb_rol  = load("rb_usage_role.json")
...
print("\n--- role_score exact match (trends/usage vs overview) ---")
check_scores("TE trends",     te_trnd, te_ov, "role_score")
check_scores("WR trends",     wr_trnd, wr_ov, "role_score")
check_scores("RB usage/role", rb_rol,  rb_ov, "role_score")
...
check_top10("RB usage/role",           rb_rol,  rb_ov,  "role_score")
